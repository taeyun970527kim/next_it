...
public class SystemMain {
	...
	public static void main(String[] args) {
		...
		// 예시
		System.out.printf("%02d장 표준입출력\n", 3); //%02d d앞에 자릿수이고, 0은 자릿수를 못메꿀 때 0으로 메꿔주는 역할
		System.out.printf("원주율은 %.02f", 3.141592); // %.0소수를 의미
		...
		// 키보드 입력 받기
		String name = scan.nextLine(); // 내용이 없으면 출력 대기 상태
		
		System.out.println(name + ": 좀 덥네요.");
		
		// scan.next() 또는 scan.nextInt() 등은 사용 하지 않기
