...
public class FileBasic {
	...
	public static void main(String[] args) {
		...
		// 폴더 만들기
		File today = new File("/home/pc11/today");
		
		System.out.println(today.exists());
		
		// 이미 폴더가 존재하면 생성되지 않는다.
		today.mkdir();
		
		System.out.println("\n=============================================================\n");
		
		// 파일 만들기
		// /home/pc11/today 안에 text.txt 파일 만들기
		File test = new File("/home/pc11/today/test.txt");
		...
		String[] stuArray = {"유정", "준호", "동욱", "현진", "민경", "진영", "대일", "창연", "자영", "성복", "민기", "동윤", "지혜", "태윤", "준하"};
		
		// today 폴더 안에 위 학생들의 폴더를 각각 만들어주세요
		
		for(int i = 0; i < stuArray.length; i++) {
			File temp = new File("/home/pc11/today/" + stuArray[i]);
			temp.mkdir();
		}
