...
//		HashSet<String> stuSet = new HashSet<>(); // 생략가능
		...
		System.out.println(stuSet); // 순서 X
		...
		System.out.println(stuSet.contains("홍민경")); // true
		System.out.println(stuSet.contains("홍민")); // false
		...
		// 0 ~ 44 => (int)(Math.random * 45); // 경우의 수가 45개
		...
		// ArrayList인 intList를 HastSet에 옮기기
