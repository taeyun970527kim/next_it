...
//		ArrayList<int> intList = new ArrayList<>();
		...
		// Wrapper Class
		// 기본 타입의 데이터를 객체(참조타입)로 사용해야 하는 경우 사용 
		
		ArrayList<Integer> intList = new ArrayList<>();
		
		int num = 12;
		
		// 기본타입의 Wrapper Class 객체로 변환 == 박싱(boxing)
		...
		// Wrapper Class 객체에 저장된 값을 기본 타입으로 꺼내기 == 언박싱(unboxing)
		...
		// 우리가 Wrapper Class를 사용하는데 불편함은 없다.
...
//		students.add(13);
		...
		System.out.println(students.indexOf("준호"));
		System.out.println(students.indexOf("준호") != -1); // .contains 와 같은 개념으로 false 리턴
		
		// .isEmpty()
		// 리스트가 비어있는지 체크
		// 비어있다면 true 리턴 / 아니라면 false 리턴
		// .size == 0 와 같다
		System.out.println(students.isEmpty()); // false 
		System.out.println(students.size() == 0); // false 
		...
		System.out.println(students);
//		students.remove(30);
//		System.out.println(students); // 해당 인덱스가 없다면 오류 뜸
		...
		System.out.println(students);
		students.remove("아무개");
		System.out.println(students); // 해당 값이 없으면 아무일도 일어나지 않는다.
