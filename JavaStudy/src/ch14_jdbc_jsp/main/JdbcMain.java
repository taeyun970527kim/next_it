...
public class JdbcMain {
	...
	public static void main(String[] args) {
		...
		System.out.println("\n" + 
				" _   __                            ______                      \n" + 
				"| | / /                            | ___ \\                     \n" + 
				"| |/ /   ___    ___   _ __    __ _ | |_/ /  __ _   __ _   ___  \n" + 
				"|    \\  / _ \\  / _ \\ | '_ \\  / _` ||  __/  / _` | / _` | / _ \\ \n" + 
				"| |\\  \\| (_) || (_) || | | || (_| || |    | (_| || (_| || (_) |\n" + 
...
//				StudentVO student = new StudentVO(id, pw, "", 0);
				...
				if(login.getStuid() != null) {
					...
					// 끝말잇기 시작
					// VO (SELECT문 매핑 객체) 만들고 DAO (쿼리문 작성) 만들고 Service (DAO 메소드 실행) 만들기
					while(true) {
						System.out.println("행동을 선택해주세요");
						...
						if(select == 1) {
							...
							while(true) {
								...
								// 1. userWord가 wordList 안에 포함되있는지 체크
								// 2. userWord의 앞글자가 computerWord에 뒷글자와 같은지 체크
								...
								if(checkOne && checkTwo) {
									...
									// userWord의 마지막 글자로 시작하는 단어들을 wordList에서 꺼내기
									...
									if(comAnswerList.size() == 0) { 
										...
										// 대답할 수 있는 목록에서 랜덤 인덱스의 단어를 꺼내서 제시
							...
							for(int i = 0; i < stuList.size(); i++) {
								System.out.println((i+1) + "등. " + stuList.get(i).getStuName() + " | " + stuList.get(i).getStuScore());
							}
